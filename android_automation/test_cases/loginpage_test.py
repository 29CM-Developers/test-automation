...
from android_automation.page_action import login_page, my_page, navigation_bar, my_edit_user_info_page
...
class LoginLogout:
    ...
    def test_email_login_success(self, wd, test_result='PASS', error_texts=[], img_src='', warning_texts=[]):
        ...
        try:
            ...
            my_edit_user_info_page.check_edit_page_id(wd, self.pconf['MASKING_EMAIL'])
