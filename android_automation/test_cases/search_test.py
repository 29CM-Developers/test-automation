        ...
        try:
            ...
            if len(delete_all) == 0:
                ...
                if response.status_code == 200:
                    ...
                    api_30th_brand_name = brands[29]['keyword']
                    print(
                        f"api_1st_brand_name : {api_1st_brand_name}, api 30th_brand_name : {api_30th_brand_name}, category_name : {category_name}")
                    # 지금 많이 찾는 브랜드 찾기
                ...
                if filter_name.text in filter_name_tag:
                    ...
                    if response.status_code == 200:
                        ...
                        if brand_1st_name == api_1st_brand_name:
                            ...
                            bottom_sheet_layer = wd.find_element(AppiumBy.ID,
                                                                 'com.the29cm.app29cm:id/design_bottom_sheet')
                            gender_filter = bottom_sheet_layer.find_element(AppiumBy.XPATH,
                                                                            '//androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View[1]/android.widget.TextView')
                            gender_filter.click()
                            print(f"성별 필터 선택 : {gender_filter.text}")
                            age_filter = bottom_sheet_layer.find_element(AppiumBy.XPATH,
                                                                         '//androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View[4]/android.widget.TextView')
                            age_filter.click()
