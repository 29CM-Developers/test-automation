            ...
            if response.status_code == 200:
                ...
                for i in range(0, 10):
                    ...
                    if feed_contents_type == 'contents':
                        feed_contents_text = feed_item_contents[i]['feedContents']
                        feed_contents_api.append(feed_contents_text)
                    else:
                        pass
                feed_contents_1st = feed_contents_api[0]
                feed_contents_2nd = feed_contents_api[1]
                ...
                for i in range(0, 10):
                    try:
                        ...
                        if feed_contents_1st == feed_contents:
                ...
                # 첫번째 피드의 첫번째 상품의 좋아요 xpath와 드아요 수 xpath
                ...
                # 저장한 두번째 피드 정보와 동일한 피드 정보가 노출 될 때까지 스크롤
                for i in range(0, 10):
                    try:
                        feed_contents = wd.find_element(AppiumBy.XPATH,
                                                        '//XCUIElementTypeCollectionView/XCUIElementTypeCell[@index="0"]/XCUIElementTypeOther/XCUIElementTypeOther[@index="1"]/XCUIElementTypeStaticText').text
                        if feed_contents_2nd == feed_contents:
